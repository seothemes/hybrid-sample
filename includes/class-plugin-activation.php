 ...
 * Theme Plugins.
 *
 * This file contains all of the recommended plugins for the Hybrid Sample theme.
 *
 ...
 */
function hybrid_sample_register_required_plugins() {
...
add_action( 'tgmpa_register', 'hybrid_sample_register_required_plugins' );
