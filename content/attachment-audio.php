<?php if ( is_attachment() ) : // If viewing a single attachment. ?>
	...
	<div class="attachment-meta">
		...
		<div class="media-info">
			...
			<h3><?php esc_html_e( 'Audio Info', 'hybrid-sample' ); ?></h3>
			...
			<ul class="media-meta">
				...
				<?php hybrid_media_meta( 'artist',           array( 'before' => sprintf( $pre, esc_html__( 'Artist',    'hybrid-sample' ) ), 'after' => '</li>' ) ); ?>
				<?php hybrid_media_meta( 'composer',         array( 'before' => sprintf( $pre, esc_html__( 'Composer',  'hybrid-sample' ) ), 'after' => '</li>' ) ); ?>
				<?php hybrid_media_meta( 'album',            array( 'before' => sprintf( $pre, esc_html__( 'Album',     'hybrid-sample' ) ), 'after' => '</li>' ) ); ?>
				<?php hybrid_media_meta( 'track_number',     array( 'before' => sprintf( $pre, esc_html__( 'Track',     'hybrid-sample' ) ), 'after' => '</li>' ) ); ?>
				<?php hybrid_media_meta( 'year',             array( 'before' => sprintf( $pre, esc_html__( 'Year',      'hybrid-sample' ) ), 'after' => '</li>' ) ); ?>
				<?php hybrid_media_meta( 'genre',            array( 'before' => sprintf( $pre, esc_html__( 'Genre',     'hybrid-sample' ) ), 'after' => '</li>' ) ); ?>
